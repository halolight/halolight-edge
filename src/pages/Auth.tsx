  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <motion.div
        ...
        className="relative hidden overflow-hidden bg-card lg:flex lg:w-1/2"
      >
        {/* Background Effects */}
        ...
        <motion.div
          ...
          className="absolute right-20 top-20 h-32 w-32 rounded-full bg-primary/10 blur-3xl"
        />
        <motion.div
          animate={{
            y: [0, 20, 0],
          ...
          className="absolute bottom-32 left-20 h-48 w-48 rounded-full bg-primary/5 blur-3xl"
        />
              ...
              {mode === 'reset-sent' ? (
                <div className="py-8 text-center">
                  ...
                  <p className="mb-6 text-muted-foreground">
                    我们已向 <span className="font-medium text-foreground">{formData.email}</span>{' '}
                    发送了密码重置链接。 请检查您的收件箱（包括垃圾邮件文件夹）。
                  </p>
