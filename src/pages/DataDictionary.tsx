      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-2">管理应用配置和常量数据</p>
          </div>
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1 min-w-0">
                          <p className="font-medium truncate">{namespace.name}</p>
                      ...
                      <TableBody>
                        {filteredEntries.map((entry) => (
                          <TableRow key={entry.id}>
                            <TableCell className="font-medium font-mono">{entry.key}</TableCell>
                            <TableCell>
        ...
        <Dialog open={isNamespaceDialogOpen} onOpenChange={setIsNamespaceDialogOpen}>
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleSaveNamespace}>
