      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-2">细粒度权限配置 · 支持批量操作和模板</p>
          </div>
              ...
              groupedPermissions.map((group) => (
                ...
                >
                  ...
                  <div className="rounded-lg border overflow-hidden">
                    {/* Header */}
                    <div className="grid grid-cols-4 gap-4 bg-muted/50 px-4 py-3 text-sm font-medium border-b">
                      <div>操作</div>
                      {roles.map((r) => (
                    ...
                    {group.actions.map((action, idx) => (
                      <div key={action.action}>
                        <div className="grid grid-cols-4 gap-4 px-4 py-3 items-center hover:bg-muted/30 transition-colors">
                          <div>
